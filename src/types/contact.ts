...
export type ContactSource = 'manual' | 'csv_import' | 'inbound_rank_checker' | 'inbound_acquisition' | 'inbound_prova_gratuita' | 'inbound_menu_landing' | 'inbound_social_proof' | 'inbound_qr_recensioni' | 'smartlead_outbound' | 'referral';
